...
$y=X\beta+\epsilon$ où $\beta \in \mathbb{R}^p$, $X$ est une matrice de taille $(n, p)$ et $\epsilon$ est un vecteur aléatoire de taille $n$, centré et de matrice de covariance $\sigma^2I_n$ ($I_n$ est la matrice identité).
