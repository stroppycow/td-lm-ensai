...
Sur la base des $n$ individus, calculer le coefficient de corrélation linéaire entre les
...
valeur de $\hat{\beta}$. C'est ce que l'on observe ici, indépendamment de la taille de l'échantillon, même si $n$ est de l'ordre du million. Une telle situation est évidemment indésirable sur le plan statistique. Cela nous
