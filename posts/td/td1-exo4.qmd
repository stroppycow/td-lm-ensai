...
### Rappel de la preuve ① : décomposition biais-variance de l'EQM

$$
\begin{align*}
\mathbb{E}\left[\left(\widehat{\beta} - \mathbb{E}\left[\widehat{\beta}\right] \right)\left(\widehat{\beta} -\mathbb{E}\left[\widehat{\beta}\right] \right)^{'}\right] &= \mathbb{E}\left[\widehat{\beta}\widehat{\beta}^{'} - \widehat{\beta}\left(\mathbb{E}\left[\widehat{\beta}\right]\right)^{'} - \mathbb{E}\left[\widehat{\beta}\right]\widehat{\beta}^{'}+ \mathbb{E}\left[\widehat{\beta}\right]\left(\mathbb{E}\left[\widehat{\beta}\right] \right)^{'} \right] \\
&= \mathbb{E}\left[\widehat{\beta}\left(\widehat{\beta} -\mathbb{E}\left[\widehat{\beta}\right] \right)^{'}\right]- \mathbb{E}\left[\widehat{\beta}\right]\mathbb{E}\left[\left(\widehat{\beta} -\mathbb{E}\left[\widehat{\beta}\right] \right)^{'}\right] \\
&= \mathbb{E}\left[\widehat{\beta}\left(\widehat{\beta} -\mathbb{E}\left[\widehat{\beta}\right] \right)^{'}\right]- \mathbb{E}\left[\widehat{\beta}\right]\mathbb{E}\left[\left(\widehat{\beta} -\mathbb{E}\left[\widehat{\beta}\right] \right)^{'}\right] \\
